...
```bash
pkg update -y && pkg install -y wget && wget https://github.com/joakimthecoder/ajtermux/raw/main/install.sh && bash install.sh
```
...
| `proxy` | AJ Proxy binary ( Growtopia trafik yönlendirici ) |
